...
# Generated by Powerlevel10k configuration wizard on 2020-02-11 at 10:38 CST.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 42403.
# Wizard options: compatible, lean, time, 1 line, compact, fluent.
...
() {
  ...
  # typeset -g POWERLEVEL9K_TIME_FORMAT='%T %d %e'
  ...
  # Only display prompt at bottom of the screen
  printf '\n%.0s' {1..100}
  # Instant prompt mode.
  #
  ...
  typeset -g POWERLEVEL9K_INSTANT_PROMPT=verbosoffe
